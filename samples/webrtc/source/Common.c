                                    ...
                                    PSampleStreamingSession* ppSampleStreamingSession)
{
    ...
    // Declare that we support H264,Profile=42E01F,level-asymmetry-allowed=1,packetization-mode=1 and ALAW
...
CleanUp:
    ...
    DLOGD("Freed streaming session with peer id: %s ", pSampleStreamingSession->peerId);
    return retStatus;
}
