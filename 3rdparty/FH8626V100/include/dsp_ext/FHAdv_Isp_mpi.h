...
enum FH_SINT32t
{
    ...
    FH_SINT32t_1_500    = 9,
    FH_SINT32t_1_750    = 9,
    FH_SINT32t_1_1000   = 10,
    FH_SINT32t_1_2000   = 11,
    FH_SINT32t_1_4000   = 12,
    FH_SINT32t_1_10000  = 13,
    FH_SINT32t_1_100000 = 14,
};
...
typedef struct
{
    FH_VOID *(*sensor_create)(FH_VOID);
    FH_UINT32 *(*get_bayer_format)(FH_VOID);
    FH_UINT32 *(*get_awb_gain)(FH_SINT32 idx);
    FH_UINT32 *(*get_ltm_curve)(FH_SINT32 idx);
    FH_UINT32 *(*get_default_param)(FH_VOID);
} FHADV_ISP_SENSOR_FUNC_t;
...
typedef struct {
    ...
    FH_SINT32 param_len;
    FH_VOID *sensor_handle;
    FHADV_ISP_SENSOR_FUNC_t funcs;
 ...
 * @return      0
 */
FH_SINT32 FHAdv_Isp_Init(FH_VOID);
 ...
 *
 * @param[in]   mode    0:手动模式，1:gainmapping模式，根据mapping选择并可以手动做整体mapping调整
 * @param[in]   value   范围-255 - 255 建议参考值范围：-50 - 50（最大值一般为默认值2倍即可）, -50 - 0调整Ngain， 0 - 50调整Pgain
 * @return      0 或 小于0的错误值
 */
FH_SINT32 FHAdv_Isp_SetSharpeness(FH_SINT32 mode, FH_SINT32 value);
