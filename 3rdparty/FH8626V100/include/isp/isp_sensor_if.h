...
#define HIGH 0
#define LOW 1
#define VI_HS_POL(x) (x)
#define VI_VS_POL(x) (1 << x)

// rgbx
#define RGBX_ENABLE 1
#define RGBX_DISABLE 0
 ...
 */
	...
	FH_SINT32	(*get_vi_mode)(int *mode);
	...
	FH_SINT32	(*set_chip_id)(int chip_id);
	...
	FH_SINT32	(*common_if)(unsigned int cmd, void* data0,void* data1);
};

enum COMMON_IF_CMD{
	CMD_INIT = 0,
	GET_SENSOR_FRAME_HEIGHT = 1,
};
