...
#ifndef __EI_AF_COMM_H__
#define __EI_AF_COMM_H__
...
#define EI_AF_LIB_NAME "ei_af_lib"

typedef struct eiAF_DRIVER_FUNC_S {
...
typedef struct eiAF_DRIVER_REGISTER_S {
    AF_DRIVER_FUNC_S stAfDrv;
    AF_DRV_ID AfDrvId;
} AF_DRIVER_REGISTER_S;
