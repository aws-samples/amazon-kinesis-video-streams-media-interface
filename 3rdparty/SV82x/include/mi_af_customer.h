...
#ifndef __MI_AF_CUSTOMER_H__
#define __MI_AF_CUSTOMER_H__
...
EI_S32 EI_MI_AF_CUSTOMER_DriverRegCallBack(ISP_DEV dev, ISP_3ALIB_S *pstAfLib, AF_DRIVER_REGISTER_S *pstRegister);
EI_S32 EI_MI_AF_CUSTOMER_DriverUnRegCallBack(ISP_DEV dev, ISP_3ALIB_S *pstAfLib, SENSOR_ID SensorId);
